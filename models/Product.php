...
class Product
{
    ...
    public static function createProduct($options)
    {
        ...
        $sql = 'INSERT INTO product values(null, :name, :category_id, :code, :price, '
    ...
    /**
     * Возвращает товары в указанном ценовом диапазоне
     */
    public static function getProductsByPrice($min, $max)
    {
        $db = Db::getConnection();

        $sql = 'SELECT id, name, price, is_new FROM product WHERE price BETWEEN :minprice AND :maxprice';
        $result = $db->prepare($sql);
    ...
    /**
     * возвращает товары по поисковому запросу
     */
    public static function getSearchResults($search){
        $db = Db::getConnection();

        $sql = "SELECT id, name, price FROM product WHERE name  LIKE :name";
        $result = $db->prepare($sql);
